 ...
 *    C++ source code generated on : 16-Aug-2020 19:38:37
 *
...
/**
     ...
     def.SourceFiles = {'acado_solver.c', 'acado_integrator.c', 'acado_auxiliary_functions.c', 'acado_solver_sfunction.c', 'acado_qpoases_interface.cpp', 'qpoases\SRC\Bounds.cpp', 'qpoases\SRC\Constraints.cpp', 'qpoases\SRC\CyclingManager.cpp', 'qpoases\SRC\Indexlist.cpp', 'qpoases\SRC\MessageHandling.cpp', 'qpoases\SRC\QProblem.cpp', 'qpoases\SRC\QProblemB.cpp', 'qpoases\SRC\SubjectTo.cpp', 'qpoases\SRC\Utils.cpp', 'qpoases\SRC\EXTRAS\SolutionAnalysis.cpp'};
...
static void mdlStart(SimStruct *S)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        __dtBusInfo[9] = 126*__dtSizeInfo[2];
        ...
        __dtBusInfo[11] = 60*__dtSizeInfo[2];
        ...
        __dtBusInfo[13] = 180*__dtSizeInfo[2];
        ...
        __dtBusInfo[15] = 6*__dtSizeInfo[2];
        ...
        __dtBusInfo[19] = 36*__dtSizeInfo[2];
        ...
        __dtBusInfo[21] = 6*__dtSizeInfo[2];
        ...
        __dtBusInfo[29] = 126*__dtSizeInfo[2];
        ...
        __dtBusInfo[31] = 60*__dtSizeInfo[2];
        ...
        __dtBusInfo[33] = 180*__dtSizeInfo[2];
        ...
        __dtBusInfo[35] = 6*__dtSizeInfo[2];
        ...
        __dtBusInfo[39] = 36*__dtSizeInfo[2];
        ...
        __dtBusInfo[41] = 6*__dtSizeInfo[2];
...
static void CheckDataTypes(SimStruct *S)
{
    ...
    {
        uint32_T chk[] = {3196016491, 328375225, 1690035487, 1927106141};
        int_T status;
    ...
    {
        uint32_T chk[] = {3039332933, 1723673660, 52228283, 1615248739};
        int_T status;
    ...
    {
        uint32_T chk[] = {3496071882, 433628689, 831197585, 2801637077};
        int_T status;
